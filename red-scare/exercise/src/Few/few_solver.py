...
class FewSolver:
    ...
    def solve(self) -> float:
        ...
        openNodes: PriorityQueue[tuple[float, Node]] = PriorityQueue()
        ...
        while not openNodes.empty():
            ...
            for edge in self.graph.getNeighbors(node):
                newDistance: float = currentDistance + edge.cost
    ...
    def prepareGraphForDijkstra(self, graph: DirectedGraph) -> DirectedGraph:
